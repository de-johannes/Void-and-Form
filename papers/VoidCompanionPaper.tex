...
A companion volume, \textit{Form}~\cite{wielsch2026form} ($\sim$9\,000 lines),
...
Postulates   & 0 & 0 \\
Result       & $(V,E,d,\chi,\kappa) = (4,6,3,2,8)$ & 35-field \texttt{StandardModelFromK4} \\
\bottomrule
\end{tabular}
\end{center}
...
invariant record to be a singleton.  \textit{Form} (${\sim}9{,}000$ lines)
