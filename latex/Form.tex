...
$\sin^2\!\theta_W$ still deviates by $3.5\,\sigma$ from measurement.
...
The three tiers of correction correspond structurally to the three
denominator scales available from $K_4$---$C^2$, $\kappa C^2$,
$\kappa^2 C^2$---which parallel the three gauge factors of the
Standard Model.  This parallel is an interpretation, not
a formal derivation:
\begin{enumerate}
\item $\kappa^0 C^2$: electromagnetic projection $\pm\chi/C^2$
      (topological weight over electromagnetic scale).
\item $\kappa^1 C^2$: strong volume correction
      $d^{1+bd}/(\kappa \cdot d^2 \cdot C^2)$
      (degree factor over strong$\,\times\,$EM scale).
\item $\kappa^2 C^2$: weak mixing correction
      $(p + \chi)^2/(\kappa^2 \cdot C^2)$
      (isospin completion over weak$\,\times\,$EM scale).
\end{enumerate}
...
record proves that the cover branch count $\chi$ forces the weak
channel, and \texttt{law-self-coupling-square} proves that
cross-invariant self-coupling squares the weight.  The remaining
interpretive step is the identification of the $\kappa^2$ denominator
scale with the weak gauge sector---a mapping from the $K_4$ ledger
to physics context.
...
Mass ratios do not receive this correction.  They are pure
$\mathrm{U}(1) \times \mathrm{SU}(3)$ observables: their tree-level
formulas involve only powers, products, and the coprime extension $F_2$.
No isospin mixing enters their computation.  The weak mixing correction
applies exclusively to $\sin^2\!\theta_W$, whose tree-level formula
$\chi/\kappa$ is itself a ratio of the two $K_4$ invariants that encode
the weak sector.

\medskip
\noindent
\textbf{Constraint:}
After the $\mathrm{U}(1)$ and $\mathrm{SU}(3)$ corrections,
$\sin^2\!\theta_W$ retains a $3.5\,\sigma$ residual that mass ratios
do not share.  This residual must originate from a gauge sector that
couples to mixing but not to mass.  The only such sector in $K_4$
is the isospin doublet encoded by $\kappa = 2V$.
...
The full gauge correction chain $\mathrm{U}(1) + \mathrm{SU}(3) +
\mathrm{SU}(2)$ closes every observable below measurement
uncertainty.

\begin{code}%
\>[0]\AgdaComment{--\ §\ Weak\ Mixing\ Correction\ —\ the\ SU(2)\ isospin\ sector\ contributes}\<%
\\
...
\toprule
Observable & Tree & 1-loop & $\mathrm{U}(1)$ & $\mathrm{SU}(3)$ & $\mathrm{SU}(2)$ \\
\midrule
$\alpha^{-1}$ & $137$ & \multicolumn{2}{c}{$0.4\,\sigma$ (2nd order)} & --- & --- \\
$m_p / m_e$ & $1836$ & $949\,\sigma$ & $20\,\sigma$ & $0.08\,\sigma$ & --- \\
$m_\mu / m_e$ & $207$ & $36\,\sigma$ & $13\,\sigma$ & $0.12\,\sigma$ & --- \\
$m_\tau / m_\mu$ & $17$ & $0.1\,\sigma$ & $0.1\,\sigma$ & $0.1\,\sigma$ & --- \\
$\sin^2\!\theta_W$ & $0.25$ & $7.7\,\sigma$ & $5.0\,\sigma$ & $3.5\,\sigma$ & $0.001\,\sigma$ \\
\bottomrule
\end{tabular}
\end{center}
%
Every observable closes below measurement uncertainty.  Each observable
couples to exactly the gauge sectors its physics demands: $\alpha^{-1}$
has its own perturbative series, mass ratios receive $\mathrm{U}(1)$
and $\mathrm{SU}(3)$ corrections, and $\sin^2\!\theta_W$ receives all
three.  The gauge structure $\mathrm{U}(1) \times \mathrm{SU}(2) \times
\mathrm{SU}(3)$ is not imposed---it emerges from which observables
require which corrections to close.
