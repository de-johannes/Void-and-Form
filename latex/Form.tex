...
%
\\[\AgdaEmptyExtraSkip]%
\>[0]\AgdaComment{--\ §\ Filter\ 1\ (no\ V):\ V\ is\ consumed\ in\ proton\ volume\ 72\ =\ V·E·d.}\<%
\\
\>[0]\AgdaComment{--\ Witness:\ V\ divides\ proton-loop-den.}\<%
\\
...
%
\\[\AgdaEmptyExtraSkip]%
\>[0]\AgdaComment{--\ §\ Filter\ 2\ (no\ κ):\ κ\ is\ consumed\ in\ electroweak\ volume\ 576\ =\ V·E·d·κ.}\<%
\\
\>[0]\AgdaComment{--\ Witness:\ κ\ divides\ loop-denom-EW.}\<%
\\
