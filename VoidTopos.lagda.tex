...
\begin{code}
-- § The cover determines each point's normal left/right code.
...
-- § Terminal arrow is determined by the source marker.
...
-- § The canonical displayed nontrivial well-pointed elementary topos with NNO.
...
-- § Classifying data for displayed models over the generated reading skeleton.
